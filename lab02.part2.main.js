 ...
 * @return {Object} responseData - Object containing an IPv4 address and an IPv6 address.
 */
function getFirstIpAddress(cidrStr, callback) {
  ...
  responseData.ipv4 = firstIpAddress;

  if (firstIpAddress) {
      responseData.ipv6 = getIpv4MappedIpv6Address(firstIpAddress);
  }
  ...
  return callback(responseData, callbackError);
}
